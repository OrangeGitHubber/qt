...
export interface BacktestResult {
  ...
  // daily_filled_held_days: how many of those fell while a position was OPEN —
  // the only ones where a stop was left waiting for a daily close.
  daily_filled_days?: number;
  daily_filled_held_days?: number;
